	...
	public function postSend(){
		...
		if (is_wp_error($response)) {
			...
			if($isOKCode && isset($responseBody['id'])) {
				...
				$returnResponse = new \WP_Error($responseCode, $responseBody, $responseBody);
			}
		}
	...
	public function load_field(){
		...
		$fields = array(
			'api_key' => array(
				...
				'type' => 'password',
				'desc' => __( 'Follow this link to get a Private API Key from Mailgun: <a href="https://app.mailgun.com/app/account/security/api_keys">Get a Private API Key.</a>' ),
			),
			'domain_name' => array(
				'title' => __('Domain Name'),
				'type' => 'text',
				'desc' => __( 'Follow this link to get a Domain Name from Mailgun: <a href="https://app.mailgun.com/app/domains">Get a Domain Name.</a>' ),
			),
			'region' => array(
				'title' => __('Region'),
				'type' => 'radio',
				...
				'desc' => __( 'Define which endpoint you want to use for sending messages.<br>If you are operating under EU laws, you may be required to use EU region. <a href="https://www.mailgun.com/about/regions/">More information</a> on Mailgun.com.' ),
			),
		);
