...
class Sparkpost extends Loader{
	...
	public function get_recipients(){
		...
		// Set Recipients
		$body['recipients'] = array_merge( $body['recipients'], $this->filterRecipientsArray($recipients_to));
	...
	public function load_field(){
		$fields = array(
			'api_key' => array(
				'title' => __('API Key'),
				'type' => 'password',
				'desc' => __( 'Follow this link to get an API Key from SparkPost: <a href="https://app.sparkpost.com/account/api-keys">Get API Key.</a>' ),
			),
			'region' => array(
				'title' => __('Region'),
				'type' => 'radio',
				...
				'desc' => __( 'Select your SparkPost account region. <a href="https://support.sparkpost.com/docs/getting-started/getting-started-sparkpost">More information </a>on SparkPost.' ),
			),
		);
