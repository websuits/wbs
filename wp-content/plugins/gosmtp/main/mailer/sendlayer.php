	...
	public function postSend(){		
		...
		if(is_wp_error($response)){
			...
			if($responseCode == 200){
				...
				$returnResponse = new \WP_Error($responseCode, $responseBody['Errors'][0]['Message'], $responseBody);
			}
		}
	...
	public function load_field(){
		...
		$fields = array(
			'api_key' => array(
				'title' => __('API Key'),
				'type' => 'password',
				'desc' => __( 'Follow this link to get an API Key from SendLayer: <a href="https://app.sendlayer.com/login">Get API Key.</a>' ),
			),
