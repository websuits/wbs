	...
	public function postSend(){		
		...
		if(is_wp_error($response)){
			...
			if($responseCode == 200) {
				...
				$returnResponse = new \WP_Error($responseCode, $responseBody['data'], $responseBody);
			}
		}
	...
	public function load_field(){
		...
		$fields = array(
			'api_key' => array(
				'title' => __('API Key'),
				'type' => 'password',
				'desc' => __( 'Follow this link to get an API Key from SMTP.com: <a href="https://my.smtp.com/settings/api">Get API Key.</a>' ),
			),
			'channel' => array(
				'title' => __('Sender Name'),
				'type' => 'text',
				'desc' => __( 'Follow this link to get a Sender Name from SMTP.com: <a href="https://my.smtp.com/login">Get Sender Name.</a>' ),
			),
		);
